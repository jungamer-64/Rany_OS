...
impl<'a> HealthLayout<'a> {
    ...
    /// FW バージョン
    pub fn fw_ver(&self) -> u32 { get_bits_u32(self.data, 10 * 32, 32) }
    
    /// HW ID
    pub fn hw_id(&self) -> u32 { get_bits_u32(self.data, 11 * 32, 32) }
    ...
    /// 0x08: SW 致命的エラー
    /// 0x09: FW アサート
    pub fn syndrome(&self) -> u8 { get_bits_u32(self.data, 13 * 32 + 24, 8) as u8 }
    
    /// 拡張症候群 (Extended Syndrome)
    pub fn ext_syndrome(&self) -> u16 { get_bits_u32(self.data, 13 * 32 + 0, 16) as u16 }
