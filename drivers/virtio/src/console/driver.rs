// ============================================================================
// drivers/virtio/src/console/driver.rs - VirtIO Console Driver
// ============================================================================
//!
...
use crate::console::init_virtio_console_for_device_at_index;
...
impl Driver for VirtioConsoleDriver {
    ...
    fn probe(&mut self) -> KapiResult<()> {
        ...
        let res =
            unsafe { init_virtio_console_for_device_at_index(0, self.mmio_base, self.pci_locator) };
