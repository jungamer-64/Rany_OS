...
impl EndpointDescriptor {
    ...
    /// 転送タイプ
    pub fn transfer_type(&self) -> crate::TransferType {
        match self.bm_attributes & 0x03 {
            0 => crate::TransferType::Control,
            1 => crate::TransferType::Isochronous,
            2 => crate::TransferType::Bulk,
            3 => crate::TransferType::Interrupt,
            _ => unreachable!(),
        }
    }
    ...
    /// エンドポイントアドレスを取得
    pub fn address(&self) -> crate::EndpointAddress {
        crate::EndpointAddress(self.b_endpoint_address)
    }
}
