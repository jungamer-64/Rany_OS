...
pub unsafe fn program_msi(bus: u8, device: u8, function: u8, msi_offset: u8, vector: u8) {
    ...
    if is_64bit {
        ...
        crate::io::pci_write(bus, device, function, msi_offset + 12,
        ...
        crate::io::pci_write(bus, device, function, msi_offset + 8,
            (data_reg & 0xFFFF0000) | (message_data as u32));
    }
    ...
    crate::io::pci_write(bus, device, function, msi_offset,
