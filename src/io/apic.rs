...
impl LocalApic {
    ...
    pub fn init(&self) {
        ...
        crate::log!("[APIC] Local APIC initialized at 0x{:X}\n", self.base_address);
    }
    ...
    pub fn start_timer(&self, vector: u8, interval_ms: u32) {
        ...
        crate::log!("[APIC] Timer started: vector={}, interval={}ms\n", vector, interval_ms);
    }
...
impl IoApic {
    ...
    pub fn init(&self) {
        ...
        crate::log!("[APIC] I/O APIC initialized at 0x{:X}, {} entries\n", 
            self.base_address, max_entries + 1);
    }
    ...
    /// IRQをCPUにルーティング
    pub fn route_irq(&self, irq: u8, vector: u8, apic_id: u8, level_triggered: bool, low_active: bool) {
