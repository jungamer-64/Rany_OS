...
// Import from controller.rs - NVMe Controller Registers and Configuration
use super::controller::{
    // Constants
    CACHE_LINE_SIZE, CQ_ENTRY_SIZE, QUEUE_ENTRY_SIZE, MAX_QUEUE_DEPTH,
    DEFAULT_QUEUE_DEPTH, MAX_SGL_ENTRIES, SECTOR_SIZE, PAGE_SIZE,
    MAX_TRANSFER_SIZE, POLL_BATCH_SIZE, DOORBELL_BATCH_THRESHOLD,
    CONTROLLER_READY_TIMEOUT_MS,
    // Admin opcodes
    ADMIN_DELETE_SQ, ADMIN_CREATE_SQ, ADMIN_GET_LOG_PAGE, ADMIN_DELETE_CQ,
    ADMIN_CREATE_CQ, ADMIN_IDENTIFY, ADMIN_ABORT, ADMIN_SET_FEATURES,
    ADMIN_GET_FEATURES, ADMIN_ASYNC_EVENT_REQ, ADMIN_NS_MGMT,
    ADMIN_FW_COMMIT, ADMIN_FW_DOWNLOAD,
    // I/O opcodes
    IO_FLUSH, IO_WRITE, IO_READ, IO_WRITE_UNCORRECTABLE, IO_COMPARE,
    IO_WRITE_ZEROES, IO_DATASET_MGMT,
    // Feature IDs
    FEATURE_ARBITRATION, FEATURE_POWER_MGMT, FEATURE_LBA_RANGE_TYPE,
    FEATURE_TEMP_THRESHOLD, FEATURE_ERROR_RECOVERY, FEATURE_VOLATILE_WC,
    FEATURE_NUM_QUEUES, FEATURE_IRQ_COALESCING, FEATURE_IRQ_CONFIG,
    FEATURE_WRITE_ATOMICITY, FEATURE_ASYNC_EVENT_CONFIG,
    // Structs
    NvmeControllerRegisters, NvmeCapabilities, CmbLocation, CmbSize, CmbInfo,
    NvmeControllerConfig, NvmeControllerStatus, NvmeAdminQueueAttributes,
};

// Import from defs.rs - PRP/SGL definitions
use super::defs::{PrpEntry, PrpList, SglType, SglDescriptor};
