...
use super::dma::{TypedDmaSlice, CpuOwned, DeviceOwned, CoherentDmaBuffer, DmaMemoryAttributes};
use super::io_scheduler::{DeviceId, IoError, IoRequestId, IoResult, PollHandler, hybrid_coordinator};
use super::dma::TypedDmaBuffer;
...
// ============================================================================
// 型安全 DMA バッファ (DMA Safety Improvements)
// ============================================================================
