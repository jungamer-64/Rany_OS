...
impl NvmePollingDriver {
    ...
    pub fn init(&mut self) -> Result<(), &'static str> {
        ...
        // TODO: Admin Queueのメモリ割り当てと設定
        // 実際の実装では以下のようにする:
        // let asq_buffer = allocate_aligned(depth * QUEUE_ENTRY_SIZE, 4096);
        // let acq_buffer = allocate_aligned(depth * CQ_ENTRY_SIZE, 4096);
        // self.setup_admin_queue(asq_buffer.phys_addr(), acq_buffer.phys_addr(), depth)?;

        // コントローラを有効化
        self.enable_controller()?;

        // TODO: Identify Controller コマンド発行
        // TODO: Set Features - Number of Queues
