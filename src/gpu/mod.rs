...
impl VirtioGpu {
    ...
    /// 2Dリソースを作成
    pub fn create_resource_2d(&self, width: u32, height: u32, format: PixelFormat) -> GpuResult<u32> {
    ...
    /// ホストに転送
    pub fn transfer_to_host_2d(&self, _resource_id: u32, _rect: &Rect, _offset: u64) -> GpuResult<()> {
        // コマンドを送信（簡略化）
        Ok(())
    }
    ...
    /// カーソルを更新
    pub fn update_cursor(&self, resource_id: u32, scanout_id: u32, x: u32, y: u32, hot_x: u32, hot_y: u32) -> GpuResult<()> {
