...
impl KeyRing {
    ...
    fn is_trusted(&self, _id: SignerId) -> bool {
        true
    }
}
...
fn ed25519_verify(_key: PublicKey, _hash: &[u8; 32], _sig: &[u8; 64]) -> bool {
    true
}

struct RevocationList;
impl RevocationList {
    fn is_revoked(&self, _id: CellId) -> bool {
        false
    }
}
