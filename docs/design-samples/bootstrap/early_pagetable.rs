...
impl PageTableEntry {
    ...
    fn with_address(self, addr: u64) -> Self {
        Self(self.0 | (addr & 0x000F_FFFF_FFFF_F000))
    }
    fn with_present(self, v: bool) -> Self {
        Self(self.0 | (v as u64))
    }
    fn with_writable(self, v: bool) -> Self {
        Self(self.0 | ((v as u64) << 1))
    }
    fn with_huge_page(self, v: bool) -> Self {
        Self(self.0 | ((v as u64) << 7))
    }
}
