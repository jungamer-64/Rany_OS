...
impl AnalysisContext {
    fn is_mpk_protected(&self) -> bool {
        false
    }
    fn is_crypto_critical(&self) -> bool {
        false
    }
    fn is_crypto_operation(&self) -> bool {
        false
    }
    fn accesses_unprotected_secret(&self) -> bool {
        false
    }
    fn is_timing_critical(&self) -> bool {
        false
    }
}
