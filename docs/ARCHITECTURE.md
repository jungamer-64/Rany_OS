...
- NET/TLS Wave8 required 配線の整合チェック（Phase A）は `bash scripts/verify_net_tls_wave8_required.sh` で実行する。
...
- NET/TLS Wave8 residual（pending監視）: `test_tls13_early_secret_no_psk`, `test_tls13_handshake_secret`, `test_tls13_master_secret`, `test_tls13_derive_secret`, `test_tls13_derive_traffic_keys`, `test_tls13_finished_key_and_verify_data`, `test_tls13_full_key_schedule`, `test_tls13_client_hello_key_share`, `test_tls13_client_hello_supported_versions`, `test_tls13_client_hello_psk_modes`, `test_tls13_strip_content_type`, `test_tls13_hkdf_expand_label_rfc8446`, `test_tls13_key_schedule_chain_consistency`, `test_tls13_finished_round_trip`
