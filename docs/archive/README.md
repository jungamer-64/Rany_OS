...
| ネットワーク / zero-copy / polling / packet ownership | [../reference/network-core.md](../reference/network-core.md), [../reference/api-reference.md](../reference/api-reference.md), [../proposals/kernel-roadmap.md](../proposals/kernel-roadmap.md), [../reference/performance-targets.md](../reference/performance-targets.md) |
