...
pub fn register_builtin_namespaces() {
    use super::{CapNamespace, DriverNamespace, FsNamespace, NetNamespace, ProcNamespace, SysNamespace, ShellControlNamespace, AsyncSwapoutNamespace, ReclaimNamespace};
