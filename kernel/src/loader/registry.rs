// ============================================================================
// ⚠️  DEAD FILE — このファイルはモジュールツリーに含まれていません。
//
// `mod registry;` がどこにも宣言されていないため、コンパイルされません。
// 正規の CellId / CellRegistry は loader/mod.rs に定義されています。
//
// 本ファイルは将来の Phase 5+ セルレジストリ移行の参考実装として
// 保持されていますが、本番コードからは参照されていません。
