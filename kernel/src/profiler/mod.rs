// ============================================================================
// src/profiler/mod.rs - サンプリングベースプロファイラ
// ============================================================================
//!
//! # サンプリングベースプロファイラ
//!
//! ## 責務
//! - CPU使用率プロファイリング (`CpuProfiler`)
//! - メモリ割り当てプロファイリング (`MemoryProfiler`)
//! - I/Oレイテンシ測定 (`LatencyProfiler`)
//! - コールスタック収集・フレームグラフ生成サポート
//!
//! ## 関連モジュール（可観測性ファミリー）
//! - `diag/` — 低レベル診断（TSC計測、ヒストグラム、トレースポイント、ベンチマーク）
//! - `monitor/` — システムスナップショット・ダッシュボード・ヘルスチェック
//!
//! ## 設計方針
