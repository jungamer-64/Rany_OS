...
pub use net::{
    ...
    bind_virtio_net_interface, for_each_virtio_net, get_poll_handler, handle_all_virtio_net_interrupts,
    handle_virtio_net_interrupt, handle_virtio_net_interrupt_for_index, init_virtio_net,
