...
use crate::mm::phys::frame_allocator::alloc_frame;
    ...
    pub(super) fn build_page_flags(protection: &Protection, address: MappedAddress) -> crate::mm::virt::higher_half::PageFlags {
        use crate::mm::virt::higher_half::PageFlags;
        ...
        if address.as_usize() < crate::mm::virt::higher_half::VirtAddr::KERNEL_BASE as usize {
    ...
    pub(super) fn map_pages(
        ...
        for i in 0..page_count {
            ...
            let map_result = unsafe {
                crate::mm::virt::higher_half::global_map_page(
                    virt_addr,
                    crate::mm::virt::higher_half::PhysAddr::new(phys_addr.as_u64()),
                    pt_flags,
                )
            };
    ...
    pub fn unmap_with_physical_dealloc(
        ...
        for i in 0..page_count {
            ...
            if let Some(phys_addr) = crate::mm::virt::higher_half::global_translate(virt_addr) {
                // ページテーブルからアンマップ
                let _ = unsafe { crate::mm::virt::higher_half::global_unmap_page(virt_addr) };
