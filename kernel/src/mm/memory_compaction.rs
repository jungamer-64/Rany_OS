...
impl FragmentationIndex {
    /// 断片化指数を計算
    pub fn calculate(buddy_stats: &super::buddy_allocator::BuddyAllocatorStats) -> Self {
...
impl ProactiveCompactionManager {
    ...
    /// 断片化指数を更新
    pub fn update_index(&mut self, stats: &super::buddy_allocator::BuddyAllocatorStats) {
...
pub fn update_fragmentation_index() {
    let stats = super::buddy_allocator::buddy_allocator_stats();
