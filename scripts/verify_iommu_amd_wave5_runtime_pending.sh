...
# Validates that AMD Wave1 residual smoke exports stay wired into runtime pending
...
if ! rg -q "const AMD_WAVE1_EXPECTED_CASES: u64 = 5;" "$RUNTIME_SUITE_FILE"; then
  echo "[verify_iommu_amd_wave5_runtime_pending] missing AMD expected count constant in ${RUNTIME_SUITE_FILE#$ROOT_DIR/}"
...
echo "[verify_iommu_amd_wave5_runtime_pending] PASS"
