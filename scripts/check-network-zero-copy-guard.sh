...
if rg -n "\\bPacketPayloadBuilder\\b|\\bappend_generated_bytes\\b|\\bappend_generated_str\\b|\\bpush_bytes\\b|\\bpush_str\\b" \
...
if rg -n "\\.(append_generated_bytes|append_generated_str|push_bytes|push_str)\\(" "${network_tree[@]}" >/dev/null; then
